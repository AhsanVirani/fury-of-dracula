                             ...
                             int *numReturnedLocs)
{
    ...
    if (doubleBack == true) {
        ...
        for (int i = 0; i < tempNum; i++) {
            ...
            if (i == hideIndex || i == doubleBackIndex) {
                continue;
            }
...
{
	// Get current location
    PlaceId currentLocation = GvGetPlayerLocation(dv->gv, player);
